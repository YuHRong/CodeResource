...
public class SavingsAccount : BankAccount
{
 ...
 {
  DefaultWithdrawalLimit = 6; // Set the default withdrawal limit for savings accounts
  DefaultMinimumOpeningBalance = 500; // Set the default minimum opening balance for savings accounts
  DefaultInterestRate = 0.01; // Set the default interest rate for savings accounts
  DefaultMinimumOpeningBalance = 500; // Set the default minimum opening balance for savings accounts
  DefaultInterestRate = 0.02; // Set the default interest rate for savings accounts
 }
