...
- [管理类实现](#管理类实现)
  - [目录在这里](#目录在这里)
  - [将 Object-Oriented 编程与结构化编程进行比较](#将-object-oriented-编程与结构化编程进行比较)
    - [结构化编程示例](#结构化编程示例)
  - [检查 Object-Oriented 编程中的类的使用](#检查-object-oriented-编程中的类的使用)
    - [封装](#封装)
    - [类生命周期](#类生命周期)
  - [实现专用、静态和嵌套类](#实现专用静态和嵌套类)
  - [访问修饰符](#访问修饰符)
  - [私有类构造函数](#私有类构造函数)
  - [静态类](#静态类)
  - [静态成员](#静态成员)
  ...
  - [实现分部类](#实现分部类)
  - [分布成员](#分布成员)
  - [指定命名和可选方法参数](#指定命名和可选方法参数)
  - [命名参数](#命名参数)
  - [可选参数](#可选参数)
  - [命名参数和可选参数的重载解析](#命名参数和可选参数的重载解析)
  - [使用初始值设定项和复制构造函数实例化对象](#使用初始值设定项和复制构造函数实例化对象)
    - [对象初始值设定项](#对象初始值设定项)
      - [具有所需修饰符的对象初始值设定项](#具有所需修饰符的对象初始值设定项)
      - [具有 init 访问器的对象初始值设定项](#具有-init-访问器的对象初始值设定项)
      - [具有类类型属性的对象初始值设定项](#具有类类型属性的对象初始值设定项)
    - [复制构造函数](#复制构造函数)
  - [检查类终结器](#检查类终结器)
  - [终结器语法](#终结器语法)
    - [垃圾回收与终结器之间的关系](#垃圾回收与终结器之间的关系)
    - [终结器示例](#终结器示例)
  - [使用终结器实现释放模式](#使用终结器实现释放模式)
...
1. `销毁`：释放对象的内存，并执行析构函数（如果指定了终结器）中定义的任何清理逻辑。
